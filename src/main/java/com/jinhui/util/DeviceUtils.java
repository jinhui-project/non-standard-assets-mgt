...
/**
 * 设备判断工具类
 * @time 2017-3-30 上午11:29:42  
 * @author wsc
 * @desc
 *
 */
public class DeviceUtils {
	private static final int PC_CHANNEL = 1;    //PC访问
	private static final int WECHAT_CHANNEL = 2;  //微信访问
    ...
    public static int whichChannel(HttpServletRequest request){
    	if(isWeChat(request) || isIOSDevice(request) || isMobileDevice(request)){
